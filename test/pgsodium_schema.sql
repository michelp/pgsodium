...
---- EXTENSION VERSION
SELECT results_eq('SELECT pgsodium.version()', $$VALUES ('3.1.8'::text)$$, 'Version of pgsodium is 3.1.7');
...
SELECT unnest(ARRAY[
    is(md5(prosrc), 'b7c2c397a60578cdcfd371d520d9b60e',
       format('Function pgsodium.%s(%s) body should match checksum',
              proname, pg_get_function_identity_arguments(oid))
    ),
    function_owner_is(
...
SELECT unnest(ARRAY[
    is(md5(prosrc), 'd87941beba33c2ac540f35d69dfa2a41',
       format('Function pgsodium.%s(%s) body should match checksum',
              proname, pg_get_function_identity_arguments(oid))
    ),
    function_owner_is(
