...
pgsodium_crypto_pwhash_str (PG_FUNCTION_ARGS)
{
	...
	success =
		crypto_pwhash_str (VARDATA (result), VARDATA (password),
		VARSIZE_ANY_EXHDR (password), crypto_pwhash_OPSLIMIT_MODERATE,
...
pgsodium_crypto_pwhash_str_verify (PG_FUNCTION_ARGS)
{
	...
	success = crypto_pwhash_str_verify (VARDATA (hashed_password),
		VARDATA (password), VARSIZE_ANY_EXHDR (password));
