...
pgsodium_sodium_bin2base64 (PG_FUNCTION_ARGS)
{
	...
	size_t      text_size =
		sodium_base64_ENCODED_LEN (bin_size,
		sodium_base64_VARIANT_URLSAFE_NO_PADDING);
	text       *base64 = (text *) _pgsodium_zalloc_text (text_size + VARHDRSZ);
	sodium_bin2base64 (PGSODIUM_CHARDATA (base64),
		text_size,
...
pgsodium_sodium_base642bin (PG_FUNCTION_ARGS)
{
	...
	size_t      bin_size;
	int         success;
	success = sodium_base642bin (PGSODIUM_UCHARDATA (bin),
		max_bin_size,
		PGSODIUM_CHARDATA (base64),
		base64_size,
		"", &bin_size, NULL, sodium_base64_VARIANT_URLSAFE_NO_PADDING);
