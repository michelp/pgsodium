...
CREATE OR REPLACE FUNCTION pgsodium.crypto_signcrypt_token_encrypt(
    sender bytea,
    recipient bytea,
    sender_sk bytea,
    recipient_pk bytea,
...
CREATE OR REPLACE FUNCTION pgsodium.crypto_signcrypt_token_decrypt(
    token text,
    sender_pk bytea,
    recipient_sk bytea,
    sender OUT bytea,
...
CREATE OR REPLACE FUNCTION pgsodium.crypto_signcrypt_token_verify(
